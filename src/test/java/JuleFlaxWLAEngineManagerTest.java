...
public class JuleFlaxWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JuleFlaxWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/JuleFlaxWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JuleFlaxWLAIW/InitOutcome.xml").getDocumentElement();
